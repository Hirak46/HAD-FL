...
HAD-FL (Hierarchical Anomaly Detection for Federated Learning) is a Byzantine-robust
aggregation framework designed to defend federated learning against poisoning attacks.
